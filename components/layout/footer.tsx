...
import { Command, Github, Twitter, Linkedin, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-8 pb-12">
          ...
          <div className="md:col-span-2 flex flex-col space-y-5">
            ...
            <div className="flex gap-3">
              <a href="#" className="h-8.5 w-8.5 flex items-center justify-center rounded-lg border border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-900 transition-colors bg-white shadow-sm">
          ...
          <div className="flex flex-col space-y-3.5">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex gap-2">
              ...
              />
              <Button type="submit" variant="primary" className="px-4 py-2 shrink-0">
